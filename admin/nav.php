        ...
        <nav class="nav">
            <div>
                <a href="index.php" class="nav__logo">
                    ...
                    <span class="nav__logo-name">CHARUSAT</span>
                </a>
                ...
                <div class="nav__list">
                    ...
                    <a href="index.php?page=subjectManage" class="nav-orderManage nav__link ">
                      <i class='bx bx-bar-chart-alt-2 nav__icon' ></i>
                      <span class="nav__name">Subject</span>
                    </a>
                    <a href="index.php?page=videoManage" class="nav__link nav-categoryManage">
                      <i class='bx bx-folder nav__icon' ></i>
                      <span class="nav__name">Video</span>
                    </a>
                    <a href="index.php?page=docManage" class="nav__link nav-menuManage">
                      <i class='bx bx-message-square-detail nav__icon' ></i>
                      <span class="nav__name">Document</span>
                    </a>
