...
<html lang="en">
  ...
  <?php include 'dbconnect.php';?>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div class="container mt-5 mb-5" style="margin-left: 126px;">
        <div class="contact2" style="background-image:url(images/map.jpg);height: 400px;width: 115%;" id="contact">
            <div class="container">
            <div class="row contact-container">
                ...
                <div class="card card-shadow border-0 mb-4">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="col-lg-4 bg-image" style="background-image:url(images/contact.jpg)">
                            <div class="detail-box p-4">
                            <h5 class="text-white font-weight-light mb-3">ADDRESS</h5>
                            <p class="text-white op-7">128-F Block<br>Sarovar Palace</p>
                            <h5 class="text-white font-weight-light mb-3 mt-4">CALL US</h5>
                            <p class="text-white op-7">8238848105<br> 6304468851</p>
                            <div class="round-social light">
                                <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=iamdhruvnagar@gmail.com" class="ml-0 text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="far fa-envelope"></i></a>
                                <a href="https://github.com/Dhruv2638" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
